...
# Update the log_epoch method in the WandBLogger class

    def log_epoch(self, epoch, train_loss, val_loss, recon_loss=None, val_recon_loss=None, learning_rate=None):
        """
